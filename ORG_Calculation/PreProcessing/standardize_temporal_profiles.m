...
validmethods = {'linear_stddev', 'stddev','linear_vast','vast','relative_change', 'mean_sub'};
    ...
    case 'relative_change'
        ...
        for c=1:size(temporal_profiles,1)
            ...
            if sum(validrange) >= (range(2)-range(1))/4
                ...
                ranged_mean(c) = mean( ranged_sig, 'omitnan' ); % Calculate the mean value of the signal before we do anything to it.
    ...
    case 'mean_sub'
        ...
        for c=1:size(temporal_profiles,1)
            ...
            if sum(validrange) >= (range(2)-range(1))/4
                ...
                standardized_profile_data(c,:) = (temporal_profiles(c,:)-ranged_mean(c)); % Standardize our signal.
            end
        end        
